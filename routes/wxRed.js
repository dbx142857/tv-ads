...
exports.createwxredAndLotteryInner = function(wxPrize, cb){
    ...
    wxredParam.risk_cntl = "IGN_FREQ_DAY_LMT" //'NORMAL'
...
exports.getWxRedState = function(req, res){
    var final = function(state){
        res.send(200, {state: state, total_mount: req.wxredLottery.total_mount, way: req.wxredLottery.way})
    }
...
/*
var param = {
    mch_billno: '1227555302201507281926925426',
    nonce_str: payUtils.getNonceStr(),
    mch_id: payConfig.baseConfig.mch_id,
    appid: payConfig.baseConfig.appid,
    bill_type: "MCHT"
